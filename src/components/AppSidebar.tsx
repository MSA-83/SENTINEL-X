...
import {
  LayoutDashboard, LogOut, Moon, Settings, Sun, Shield, Network, BarChart3,
  Bot, Crosshair, Layers
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/assets", label: "Asset Tracking", icon: Crosshair },
  { href: "/cases", label: "Case Management", icon: Shield },
